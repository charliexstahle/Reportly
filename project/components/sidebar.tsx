...
// Updated SidebarBody to mimic demo sidebar behavior with desktop and mobile variants
...
// Removed the old CustomSidebar default export to align with the demo sidebar structure
